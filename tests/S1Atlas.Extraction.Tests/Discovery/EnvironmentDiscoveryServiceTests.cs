...
public sealed class EnvironmentDiscoveryServiceTests
{
    ...
    public async Task DiscoverAsync_WithValidInstallation_CreatesFingerprintAndSnapshot()
    {
        ...
        var installation = new ScheduleOneInstallation(
            "C:\\Fake\\Schedule I",
            "C:\\Fake\\Schedule I\\GameAssembly.dll",
            "C:\\Fake\\Schedule I\\Schedule I_Data\\il2cpp_data\\Metadata\\global-metadata.dat",
            "C:\\Fake\\Schedule I\\Mods",
            "C:\\Fake\\Schedule I\\MelonLoader");
        ...
        var result = await service.DiscoverAsync("C:\\Fake\\Schedule I", "0.1.0", cancellationToken);

        Assert.NotNull(result);
        Assert.Equal(BuildFingerprint.Create("assembly-hash", "metadata-hash"), result.Build.BuildId);
    ...
    private sealed class FakeLocator(ScheduleOneInstallation? installation) : IScheduleOneLocator
    {
    ...
    private sealed class FakeDependencyDetector(IReadOnlyList<DependencyVersion> dependencies) : IDependencyDetector
    {
        public IReadOnlyList<DependencyVersion> Detect(ScheduleOneInstallation installation) => dependencies;
    }
}
